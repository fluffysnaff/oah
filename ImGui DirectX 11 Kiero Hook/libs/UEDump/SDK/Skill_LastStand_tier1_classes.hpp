...
// BlueprintGeneratedClass Skill_LastStand_tier1.Skill_LastStand_Tier1_C
// 0x0010 (0x00E0 - 0x00D0)
class USkill_LastStand_Tier1_C : public USkill_base_C
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_Skill_LastStand_Tier1_C;            // 0x00D0(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
	int32                                         Bullets;                                           // 0x00D8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

public:
	void ExecuteUbergraph_Skill_LastStand_Tier1(int32 EntryPoint);
	void SetupSkill();
